...
public interface PensumMateriaRepository extends CrudRepository<PensumMateriaEntity,Long> {
    ...
    @Query(value = "SELECT pm.id, m.id as idMateria, pm.codigo, m.nombre, m.horas, m.creditos, pm.semestre, pm.cod_perrequisito as codPerrequisito, pm.cre_perrequisito as crePerrequisito, m.microcurriculo" +
